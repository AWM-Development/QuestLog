ALTER TABLE "entities" ADD COLUMN "parent_entity_id" uuid;--> statement-breakpoint
...
CREATE INDEX "entities_parent_entity_id_idx" ON "entities" USING btree ("parent_entity_id");