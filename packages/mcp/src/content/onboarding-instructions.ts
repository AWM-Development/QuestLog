...
- \`create_entity\` and \`append_entity_note\` to author NPCs, locations, factions, items, and arcs directly. \`update_entity\` (then \`confirm_update_entity\`) to rename one, replace its description, or change its type.
