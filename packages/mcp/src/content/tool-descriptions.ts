...
export const CONFIRM_CORRECT_LORE_DESCRIPTION =
	"Confirm a previously-previewed correct_lore change-set: chunks and embeds the correction as new authoritative content and marks every target chunk superseded, all inside a single transaction.";
