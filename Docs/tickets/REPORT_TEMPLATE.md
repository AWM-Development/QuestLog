...
- "Test evidence" means pasted output. A report that says "tests pass" without showing the run is not acceptable — this is the same discipline as `AGENTS.md`'s "never claim done without showing output."
