...
Context files (load ONLY these):
  - Docs/tickets/T-046-executor-usage-capture-hook.md (the `packages/core/src/usage-capture/` module this ticket adds to, once drafted — read for its conventions, don't duplicate its scope)
